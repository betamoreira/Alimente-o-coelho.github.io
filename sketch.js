...
function setup() 
{
  ...
  ropes2 = new Rope(7,{x:370,y:40});
  ropes3 = new Rope(4,{x:400,y:220});
  ...
  frutalink2 = new Link(ropes2,fruta); 
  frutalink3 = new Link(ropes3,fruta); 
...
function draw() 
{
  ...
  image(bgimage,width/2,height/2,canW,canH);
